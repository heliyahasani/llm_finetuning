...
parser.add_argument('--model', type=str, default='meta-llama/Llama-2-7b-hf', help='Model to use')
...
parser.add_argument('--token', type=str, default=$your_token, help='Your hugging face token should be replaced with $your_token')
